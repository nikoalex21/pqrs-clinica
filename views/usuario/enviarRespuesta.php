...
if (isset($_REQUEST['id'])) {
    ...
    $idDetalleCausal = $datos[0]['idDetalleCausal'];
    $idPersona = $datos[0]['idPersona'];
    $descripcionEdit = $datos[0]['descripcionEdit'];
                ...
                <div class="col-md-4"  style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="custom-input-group">
                            ...
                            <textarea class="form-control" name="idDetalleCausal" rows="1" id="idDetalleCausal"><?php echo $idDetalleCausal; ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4"  style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="custom-input-group">
                            ...
                            <textarea class="form-control" name="descripcionEdit" rows="1" id="descripcionEdit"><?php echo $descripcionEdit; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4"  style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="custom-input-group">
                            ...
                            <textarea class="form-control" name="idArea" rows="1" id="idArea"><?php echo $idArea; ?></textarea>
                        </div>
                    </div>
                </div>
