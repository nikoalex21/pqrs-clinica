...
<div class="container mt-5 my-custom-container">
    <form class="needs-validation" action="../../Controler/Pqrs_pqr_controler.php" method="post" enctype="multipart/form-data" novalidate>
       <div class="card">
            <div class="card-body">
                <h1 class="card-title">Respuestas PQRS</h1>
                <input type="hidden" name="tarea" value="create_pqrs_respuesta">
                    <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="col-md-4" style="display: none;">
                            <div class="form-group">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <textarea class="form-control" name="idCoordinador" rows="1" id="idCoordinador"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-input-group">
                                        ...
                                        <input type="text" disabled value="<?php echo $resultado2['descripcionEdit']; ?>" class="form-control" name="descripcionEdit" id="descripcionEdit">
                                    </div>
                                </div>  
                            </div>
